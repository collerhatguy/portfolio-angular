...
const projects: Project[] = [
  {
    ...
    siteName: 'Tetris Remake',
    repository: `https://github.com/collerhatguy/tetris-game`,
    liveServer: 'https://collerhatguy.github.io/tetris-game/',
    technologies: ['Angular', 'Typscript', 'SCSS', 'RXJS'],
  },
  {
    repoName: 'org-net2',
